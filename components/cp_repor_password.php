<main class="bg-light">
    <section class="container py-5 mt-5">
        ...
        <form action="scripts/sc_repor_pass.php" method="post">
                        ...
                        if (isset($_GET["msg"])) {
                            ...
                            switch ($_GET["msg"]) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    $message = "Email enviado com sucesso. Verifique a sua caixa de correio.";
                                    $class = "alert-success";
                                    break;
                                default:
                                    $msg_show = false;
  ...
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
    <span aria-hidden=\"true\">&times;</span>
                    ...
                    <div class="form-group pt-4">
                        <input class="btn btn-inform btn-block text-uppercase py-3" type="submit" name="continuar" value="continuar">
                    </div>
                </div>
            </div>
        </form>
